...
<tr class="ppwp_free_version ppwp_logic_show_input_password <?php echo esc_attr( $is_display ); ?>">
	...
	<td>
		<p>
			<label><?php echo esc_html__( 'Cookie Expiration Time For Sitewide', 'password-protect-page' ); ?></label>
			<?php 
			// phpcs:disable
			/* translators: %1$s opens a link, %2$s closes the link. Explains session cookie behavior. */
			printf(
					    wp_kses_post(
